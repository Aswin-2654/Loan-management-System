...
class MPINSetupRequest(BaseModel):
    mpin: str = Field(..., min_length=4, max_length=4, regex="^[0-9]{4}$")
...
class MPINResetRequest(BaseModel):
    old_mpin: str = Field(..., min_length=4, max_length=4, regex="^[0-9]{4}$")
    new_mpin: str = Field(..., min_length=4, max_length=4, regex="^[0-9]{4}$")
    confirm_mpin: str = Field(..., min_length=4, max_length=4, regex="^[0-9]{4}$")
